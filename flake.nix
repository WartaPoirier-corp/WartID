          ...
          with lib;
          {
            ...
            config = mkIf cfg.enable {
              ...
              systemd.services.wartid-server = {
                ...
                serviceConfig = {
                  ExecStart = "/${self.packages.${nixpkgs.system}.wartid-server}/bin/wartid-server";
                  Type = "simple";
                  User = "wartid";
                  Group = "wartid";
                };
              ...
              systemd.services.wartid-server-discord-bot = mkIf cfg.enableDiscordBot {
                ...
                serviceConfig = {
                  ExecStart = "/${self.packages.${nixpkgs.system}.wartid-server-discord-bot}/bin/wartid-server-discord-bot";
                  Type = "simple";
                  User = "wartid";
                  Group = "wartid";
                };
